...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 25, 2019 at 03:51 PM
...
CREATE TABLE `fundseeker_application` (
  ...
  `pan_back` text NOT NULL,
  `pan` varchar(100) DEFAULT NULL,
  `gstin` varchar(20) NOT NULL,
  `reg_num` varchar(50) NOT NULL,
  `category_id` int(9) NOT NULL,
  `turnover_id` int(9) NOT NULL,
...
INSERT INTO `fundseeker_application` (`fundseeker_application_id`, `fundseeker_id`, `description`, `company`, `adhaar_front`, `adhaar_back`, `adhaar`, `pan_front`, `pan_back`, `pan`, `gstin`, `reg_num`, `category_id`, `turnover_id`, `address`, `website`, `annual_report`, `status`, `bank_status`, `date_of_apply`) VALUES
(1, 1, 'Lorem ipsum dolor sit amet', 'Zain Technocrats', 'uploads/application/adhaar2452_front.png', 'uploads/application/adhaar2452_back.jpg', '82728934238642384', 'uploads/application/pan_front.png', 'uploads/application/pan_back.jpg', 'AXB9889A', '245276A', '245253A', 1, 2, 'test address', 'http://fundgogo.com', 'uploads/applciation/annual_report.pdf', 0, 2147483647, '2019-02-25 08:14:29');
...
--
ALTER TABLE `fundseeker`
  MODIFY `fundseeker_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `fundseeker_application`
--
ALTER TABLE `fundseeker_application`
  MODIFY `fundseeker_application_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `investors`
--
ALTER TABLE `investors`
  MODIFY `investors_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
