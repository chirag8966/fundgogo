        ...
        <div class="row">
          <div class="col-sm-6 col-md-6 col-lg-3">
            ...
            <div class="team-item text-center wow fadeInRight" data-wow-delay="0.3s">
              <div class="team-img">
                <img class="img-fluid" src="<?=base_url()?>assets/img/team/team-01.png" alt="">
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            ...
            <div class="team-item text-center wow fadeInRight" data-wow-delay="0.6s">
              <div class="team-img">
                <img class="img-fluid" src="<?=base_url()?>assets/img/team/team-02.png" alt="">
                <div class="team-overlay">
                  <div class="overlay-social-icon text-center">
                    <ul class="social-icons">
                      <li><a href="#"><i class="lni-facebook-filled" aria-hidden="true"></i></a></li>
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            ...
            <div class="team-item text-center wow fadeInRight" data-wow-delay="0.9s">
              <div class="team-img">
                <img class="img-fluid" src="<?=base_url()?>assets/img/team/team-03.png" alt="">
                <div class="team-overlay">
                  <div class="overlay-social-icon text-center">
                    <ul class="social-icons">
                      <li><a href="#"><i class="lni-facebook-filled" aria-hidden="true"></i></a></li>
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            ...
            <div class="team-item text-center wow fadeInRight" data-wow-delay="1.2s">
              <div class="team-img">
                <img class="img-fluid" src="<?=base_url()?>assets/img/team/team-04.png" alt="">
                <div class="team-overlay">
                  <div class="overlay-social-icon text-center">
                    <ul class="social-icons">
                      <li><a href="#"><i class="lni-facebook-filled" aria-hidden="true"></i></a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-12 col-xs-12 wow fadeInLeft" data-wow-delay="0.3s">
            <img class="img-fluid" src="<?=base_url()?>assets/img/about/img-1.jpg" alt="" >
          </div>
            ...
            <div id="testimonials" class="owl-carousel wow fadeInUp" data-wow-delay="1.2s">
              <div class="item">
                <div class="testimonial-item">
                  <div class="img-thumb">
                    <img src="<?=base_url()?>assets/img/testimonial/img1.jpg" alt="">
                  </div>
                  <div class="info">
              ...
              <div class="item">
                <div class="testimonial-item">
                  <div class="img-thumb">
                    <img src="<?=base_url()?>assets/img/testimonial/img2.jpg" alt="">
                  </div>
                  <div class="info">
              ...
              <div class="item">
                <div class="testimonial-item">
                  <div class="img-thumb">
                    <img src="<?=base_url()?>assets/img/testimonial/img3.jpg" alt="">
                  </div>
                  <div class="info">
              ...
              <div class="item">
                <div class="testimonial-item">
                  <div class="img-thumb">
                    <img src="<?=base_url()?>assets/img/testimonial/img4.png" alt="">
                  </div>
                  <div class="info">
              ...
              <div class="item">
                <div class="testimonial-item">
                  <div class="img-thumb">
                    <img src="<?=base_url()?>assets/img/testimonial/img5.png" alt="">
                  </div>
                  <div class="info">
        ...
        <div class="row">
            ...
            <div class="blog-item-wrapper wow fadeInLeft" data-wow-delay="0.3s">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="<?=base_url()?>assets/img/blog/img1.jpg" alt="">
                </a>                
              </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper wow fadeInUp" data-wow-delay="0.6s">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="<?=base_url()?>assets/img/blog/img2.jpg" alt="">
                </a>                
              </div>
              <div class="blog-item-text"> 
                <h3>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper wow fadeInRight" data-wow-delay="0.3s">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="<?=base_url()?>assets/img/blog/img3.jpg" alt="">
                </a>                
              </div>
              <div class="blog-item-text"> 
                <h3>
        ...
        <div class="row text-align-">
          <div class="col-lg-3 col-md-3 col-xs-12 wow fadeInUp" data-wow-delay="0.3s">
            <div class="client-item-wrapper">
              <img class="img-fluid" src="<?=base_url()?>assets/img/clients/img1.png" alt="">
            </div>
          </div>
          <div class="col-lg-3 col-md-3 col-xs-12 wow fadeInUp" data-wow-delay="0.6s">
            <div class="client-item-wrapper">
              <img class="img-fluid" src="<?=base_url()?>assets/img/clients/img2.png" alt="">
            </div>
          </div>
          <div class="col-lg-3 col-md-3 col-xs-12 wow fadeInUp" data-wow-delay="0.9s">
            <div class="client-item-wrapper">
              <img class="img-fluid" src="<?=base_url()?>assets/img/clients/img3.png" alt="">
            </div>
          </div>
          <div class="col-lg-3 col-md-3 col-xs-12 wow fadeInUp" data-wow-delay="1.2s">
            <div class="client-item-wrapper">
              <img class="img-fluid"  src="<?=base_url()?>assets/img/clients/img4.png" alt="">
            </div>
          </div>
        </div>
      </div>
